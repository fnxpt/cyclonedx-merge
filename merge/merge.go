...
func MergeSBOM(b1 *cyclonedx.BOM, b2 *cyclonedx.BOM) {
	...
	if b2.Metadata != nil {
		if b2.Metadata.Component != nil {
			...
			utils.MergeDependencies(b1.Dependencies, &[]cyclonedx.Dependency{{Ref: b1.Metadata.Component.BOMRef, Dependencies: &[]string{b2.Metadata.Component.BOMRef}}})
	...
	utils.MergeDependencies(b1.Dependencies, b2.Dependencies)
}
